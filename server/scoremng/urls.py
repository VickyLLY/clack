...
urlpatterns = [
    ...
    path('student_check_scores/<str:student_number>/', views.student_check_scores, name='student_check_scores'),
    path('courses_comment/<str:student_number>/', views.courses_comment, name='courses_comment'),
    path('student_download_scores/<str:student_number>/', views.student_download_scores, name='student_download_scores'),
