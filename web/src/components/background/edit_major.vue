<template>
  <div>
        ...
        <el-row>
          <el-col :span="24">
            <el-table :data="classroom_list" tooltip-effect="dark" style="width:100%" :default-sort="{prop:'create_time',order:'descending'}" @selection-change="selectionButton">
              ...
              <el-table-column prop="major_department_id" label="专业ID" sortable>
              </el-table-column>
    ...
    <!--添加信息窗口-->
    <el-dialog title="添加专业信息" :visible.sync="add_dialog" @close="reset_form('add_form')">
      <el-form :model="add_form" :rules="data_rules" ref="add_form" label-width="100px">
        ...
        <el-form-item label="专业ID" prop="major_department_id">
    ...
    <!--修改信息窗口-->
    <el-dialog title="修改信息" :visible.sync="edit_dialog" @close="reset_form('edit_form')">
      ...
      submit_form:function(form_name){
        this.$refs[form_name].validate((valid)=>{
          if(valid){
            ...
            this.$http.post(this.Global_Api + '/entity/new_major',data).then(response=>{
