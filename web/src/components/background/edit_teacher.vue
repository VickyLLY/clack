<template>
  <div>
        ...
        <el-row>
          <el-col :span="24">
            <el-table :data="classroom_list" tooltip-effect="dark" style="width:100%" :default-sort="{prop:'create_time',order:'descending'}" @selection-change="selectionButton">
              ...
              <el-table-column prop="teacher_department_id" label="教师学院ID" sortable>
              </el-table-column>
    ...
    <!--添加信息窗口-->
    <el-dialog title="添加教师信息" :visible.sync="add_dialog" @close="reset_form('add_form')">
      <el-form :model="add_form" :rules="data_rules" ref="add_form" label-width="100px">
        ...
        <el-form-item label="教师学院ID" prop="teacher_department_id">
    ...
    <!--修改信息窗口-->
    <el-dialog title="修改教师信息" :visible.sync="edit_dialog" @close="reset_form('edit_form')">
      <el-form :model="edit_form" :rules="data_rules" ref="edit_form" label-width="100px">
        ...
        <el-form-item label="教师编号" prop="teacher_number">
          <el-input type="text" v-model="edit_form.teacher_number"></el-input>
        </el-form-item>
        <el-form-item label="教师邮箱" prop="teacher_email">
          ...
          if(valid){
            let data = {
              ...
              "classroom": {
                ...
                "teacher_number":parseInt(this.add_form.teacher_number),
                "teacher_email":this.add_form.teacher_email,
                "teacher_department_id":this.add_form.teacher_department_id

              }
            };
            this.$http.post(this.Global_Api + '/background/add_teacher',data).then(response=>{
